...
@router.get("/average-price-per-category", response_model=List[AveragePricePerCategorySchema])
def read_average_price_per_category():
...
def read_top_categories(limit: int = 5):
